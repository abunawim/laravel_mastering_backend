...
<head>
		...
		<title>Dashboard | Porto Admin - Responsive HTML5 Template 1.5.0</title>
		...
		<script src="{{asset('public/assets/vendor/style-switcher/style.switcher.localstorage.js')}}"></script>
	...
	<body>
		<section class="body">
			...
			<header class="header">
				...
				<div class="header-right">
					...
					<form action="http://preview.oklerthemes.com/porto-admin/1.5.0/pages-search-results.html" class="search nav-form">
			...
			<!-- End sidebar  -->
				<section role="main" class="content-body">
					...
					@include('backendcode.deshboard_homepage')
		...
		<script src="{{asset('public/assets/vendor/style-switcher/style.switcher.js')}}"></script>		
		...
		<script src="{{asset('public/assets/vendor/jqueryui-touch-punch/jqueryui-touch-punch.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jquery-appear/jquery-appear.js')}}"></script>		
		...
		<script src="{{asset('public/assets/vendor/flot.tooltip/flot.tooltip.js')}}"></script>		
		...
		<script src="{{asset('public/assets/vendor/jquery-sparkline/jquery-sparkline.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/raphael/raphael.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/morris.js/morris.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/gauge/gauge.js')}}"></script>		
		...
		<script src="{{asset('public/assets/vendor/jqvmap/jquery.vmap.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/data/jquery.vmap.sampledata.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/jquery.vmap.world.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.africa.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.asia.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.australia.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.europe.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js')}}"></script>		
		<script src="{{asset('public/assets/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js')}}"></script>
		...
		<!-- Examples -->
		<script src="{{asset('public/assets/javascripts/dashboard/examples.dashboard.js')}}"></script>
	</body>
